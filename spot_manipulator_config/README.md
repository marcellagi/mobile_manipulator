...
#### 1.1.1. Run the base driver:
    ...
    roslaunch spot_manipulator_config bringup.launch rviz:=true
...
#### 1.2.1. Run the Gazebo environment:
    ...
    roslaunch spot_manipulator_config gazebo.launch 

#### 1.2.2. Run gmapping package and move_base:

    roslaunch spot_manipulator_config slam.launch rviz:=true
...
- Save the map by running:
      ...
      roscd spot_manipulator_config/maps
...
#### 1.3.2. Run amcl and move_base:
    ...
    roslaunch spot_manipulator_config navigate.launch rviz:=true
...
Spawning a robot:
    ...
    roslaunch spot_manipulator_config spawn_robot.launch robot_name:=<unique_robot_name> world_init_x:=<x_position> world_init_y:=<y_position>
